...
export default function FlatSectionListScreen() {
  ...
  //declaracion de variable para secciones, "diccionario"
  const [secciones, setSecciones] = useState([
    ...
    },
    {
      ...
      data: ['Vida', 'DelValle', 'Boing']
    },
    {
      tituloCategoria: 'Dulces',
      data: ['Chicle', 'Paleta', 'Pecositas'],
    },
    {
      tituloCategoria: 'Cheetos',
      data: ['Takis', 'Papirringas', 'Flamin Hot']
    },
    {
      tituloCategoria: 'Galletas',
      data: ['Chokis', 'Emperador', 'Principe']
    },
  ]);
  //funcion flecha para eliminar
  const eliminarElemento = (id) => {
    setElementos(elementos.filter(item => item.id != id));
  };
  //funcion flecha para renderizar contenido
